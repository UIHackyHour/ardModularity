...
```{r}
fcon_matrix <- read.csv("/Volumes/vosslabhpc/TemporarySharing/ARD/AH_Corr_Data_Nov1/GraphTheory/AndrewsHanna_Buckner98_correlationData_ROInamesShortened.csv", header=TRUE, sep = ",", row.names=1)  
...
new_cols <- c("white", "red", "black")[membership(c2)]
plot(c2, g, col=new_cols, mark.border="black", mark.col=c("lightgreen", "pink", "purple", "yellow"), 
