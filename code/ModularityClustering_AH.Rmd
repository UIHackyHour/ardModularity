...
```{r}
lesion_roiPair_corr <- read.csv("/Users/ARD/Downloads/0747_power264_corr.csv", header=FALSE, sep = ",", fill = TRUE)  #Loading: load csv of left+right hemispheres lesioned ROI-ROI correlation pairs
